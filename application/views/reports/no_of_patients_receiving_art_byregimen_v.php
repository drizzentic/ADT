...
<div id="wrapperd">
	...
	<div id="patient_enrolled_content" class="full-content">
		...
		<h4 style="text-align: center" id='report_title'>Active Patients  (<?= $group.' '.$gender;?>) By Regimen Between of <span  id="date_of_appointment"><?= $from;?>  </span> and <span  id="date_of_appointment"><?= $to;?>  </span> </h4>

...
<form name="pqmp-form" id="pqmp-form" method="POST" action="">
  <table border="1" style="">
    ...
    <tr>
      <td colspan="4">Name of reporter : <input type="text" name="reporter_name" id="reporter_name" class="form-control"> </td>
      <td colspan="4">Contact Number : <input type="text" name="reporter_phone" id="reporter_phone" class="form-control"> </td>
    </tr>
    <tr>

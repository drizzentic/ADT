    ...
    <form name="pqmp-form" id="pqmp-form" method="POST" action="<?= base_url(); ?>inventory_management/pqmp/<?= $record_no; ?>">
        <table border="1" style="">
            <tr>
                ...
                <td colspan="3">County: 
                    <select name="county_id" id="county_id" class="fil" >
                        <option value="<?= $pqmp_data[0]['county_id'] ?>" selected="selected"><?= $pqmp_data[0]['county_name'] ?></option>
                ...
                <td colspan="3">Sub County: 
                    <select name="sub_county_id" id="sub_county_id" class="fil" >                       
                        <option value="<?= $pqmp_data[0]['sub_county_id'] ?>" selected="selected"><?= $pqmp_data[0]['sub_county_name'] ?></option>

...
<!--scripts-->
<script src="<?= $this->config->item('adt_url');?>assets/scripts/bootstrap/bootstrap-multiselect.js"></script>
...
<script src="<?= $this->config->item('adt_url');?>assets/scripts/access-migration.js"></script>